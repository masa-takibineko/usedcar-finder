...
export default function Risks() {
  return (
    <main style={{ maxWidth: 860, margin: "40px auto", padding: "0 16px", color: "#1a1a1a" }}>
      <h1 style={{ marginBottom: 8, color: "#1a1a1a" }}>オークション代行のデメリットと注意点</h1>
      ...
      <section style={{ marginTop: 28 }}>
        <h2 style={{ marginBottom: 6, color: "#1a1a1a" }}>1. 試乗はできません</h2>
      ...
      {/* --- 2 --- */}
      <section style={{ marginTop: 28 }}>
        <h2 style={{ marginBottom: 6, color: "#1a1a1a" }}>2. 落札後の車両の不具合は基本的にはユーザー様負担となります。</h2>
        <p style={{ color: "#4a5568", lineHeight: 1.7 }}>
      ...
      {/* --- 3 --- */}
      <section style={{ marginTop: 28 }}>
        <h2 style={{ marginBottom: 6, color: "#1a1a1a" }}>3. 支払いは基本的に現金一括のみ</h2>
        <p style={{ color: "#4a5568", lineHeight: 1.7 }}>
      ...
      <p style={{ marginTop: 32, color: "#1a1a1a", fontWeight: 700 }}>
        ※ 弊社の利益は <strong>オークション代行手数料のみ</strong> です。  
        その他の追加手数料は一切いただきません。
      </p>

      <section style={{ marginTop: 32, lineHeight: 1.7 }}>
        <h2 style={{ color: "#1a1a1a" }}>中古車オークション特有のリスク</h2>
        <p style={{ color: "#4a5568" }}>
          中古車オークションでは、実車確認ができない点が最大の特徴です。そのため、出品票の情報を正しく理解することが重要です。
        </p>

        <h3 style={{ color: "#1a1a1a" }}>よくある注意点</h3>
        <ul style={{ color: "#4a5568" }}>
          <li>試乗ができない</li>
          <li>ノークレーム・ノーリターンが基本</li>
          <li>支払いが現金ベースになるケースが多い</li>
        </ul>
        <p style={{ color: "#4a5568" }}>これらを理解した上で利用する必要があります。</p>

        <h3 style={{ color: "#1a1a1a" }}>丸印モーターでの回避策</h3>
        <p style={{ color: "#4a5568" }}>
          丸印モーターでは、評価点や修復歴、注意事項を事前に説明し、リスクを理解した上で判断できる環境を提供しています。
        </p>
      </section>
