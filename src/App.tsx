    ...
    <>
      ...
      <section className="hero">
        ...
        <div className="prose">
          ...
          <ol>
            <li>
              画面の検索欄で「メーカー・車種・年式」などを選ぶと、
              <strong>実際のオークション落札相場</strong>が分かります。
            </li>
            <li>
              検索した中で購入したい車両、予算を決める。画面内の<strong>「LINEでお問い合わせ」</strong>をタップ。
              公式LINEを友だち追加で、<strong>弊社に代行依頼</strong>していただきます。
            </li>
            <li>
              その後公式LINEの中で、弊社がオークションにて落札、<strong>お客様にて指定の口座に振込 → 納車</strong>という流れになります。
            </li>
          </ol>
